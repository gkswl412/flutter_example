...
class StatModel {
  ...
  @override
  String toString() {
    return 'StatModel{daegu: $daegu, chungnam: $chungnam, incheon: $incheon, daejeon: $daejeon, gyeongbuk: $gyeongbuk, sejong: $sejong, gwangju: $gwangju, jeonbuk: $jeonbuk, gangwon: $gangwon, ulsan: $ulsan, jeonnam: $jeonnam, seoul: $seoul, busan: $busan, jeju: $jeju, chungbuk: $chungbuk, gyeongnam: $gyeongnam, dataTime: $dataTime, itemCode: $itemCode, gyeonggi: $gyeonggi}';
  }
}
